...
$popular = get_posts( [
    ...
    'order'          => 'DESC',
    'post_status'    => 'publish',
    'tax_query'      => [ [ 'taxonomy' => 'sw_platform', 'field' => 'term_id', 'terms' => $term->term_id ] ],
] );
?>
<div class="container"><?php svault_breadcrumbs(); ?></div>

<?php if ( $popular ) :
    get_template_part( 'template-parts/carousel', null, [ 'posts' => $popular, 'id' => 'plat-pop', 'title' => 'على ' . esc_html( $term->name ) ] );
endif; ?>
